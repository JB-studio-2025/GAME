...
Game.add_to_recorded_array = function(button) {
	Game.RECORDED_ARRAY = [[Game.get_in_round_time(), button, 0]].concat(Game.RECORDED_ARRAY);
}
...
Game.load_UI_elements = function() {
	...
	Game.bakgrund.src = "UI/babababa.png";
	...
	Game.scoreboard_text.src = "end_animations/scoreboard.png"
