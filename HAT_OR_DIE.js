...
Game.load_WINNING = function() {
	...
	Game.win02.src = "./player_sprites/_D/win/win1/finishhhhhhhhhh3.png"
	Game.win03 = new Image();
	Game.win03.src = "./player_sprites/_D/win/win1/finishhhhhhhhhh4.png"
	Game.win04 = new Image();
	Game.win04.src = "./player_sprites/_D/win/win1/finishhhhhhhhhh5.png"
	Game.win05 = new Image();
	Game.win05.src = "./player_sprites/_D/win/win1/finishhhhhhhhhh6.png"
	Game.win06 = new Image();
	Game.win06.src = "./player_sprites/_D/win/win1/finishhhhhhhhhh7.png"
	//Game.win07 = new Image();
	//Game.win07.src = "./player_sprites/_D/win/win1/finishhhhhhhhhh8.png"
	
	Game.win1 = new Image();
	Game.win1.src = "./player_sprites/_D/win/1.png"
	Game.win2 = new Image();
	Game.win2.src = "./player_sprites/_D/win/2.png"
	Game.win3 = new Image();
	Game.win3.src = "./player_sprites/_D/win/3.png"
	Game.win4 = new Image();
	Game.win4.src = "./player_sprites/_D/win/4.png"
	Game.win5 = new Image();
	Game.win5.src = "./player_sprites/_D/win/5.png"
	Game.win6 = new Image();
	Game.win6.src = "./player_sprites/_D/win/6.png"
	Game.win7 = new Image();
	Game.win7.src = "./player_sprites/_D/win/7.png"
	Game.win8 = new Image();
	Game.win8.src = "./player_sprites/_D/win/8.png"
	Game.win9 = new Image();
	Game.win9.src = "./player_sprites/_D/win/9.png"
	Game.win10 = new Image();
	Game.win10.src = "./player_sprites/_D/win/10.png"

	Game.poof1 = new Image();
	Game.poof1.src = "./player_sprites/_D/win/POOF/1.png"
	Game.poof2 = new Image();
	Game.poof2.src = "./player_sprites/_D/win/POOF/2.png"
	Game.poof3 = new Image();
	Game.poof3.src = "./player_sprites/_D/win/POOF/3.png"
	Game.poof4 = new Image();
	Game.poof4.src = "./player_sprites/_D/win/POOF/4.png"
	Game.poof5 = new Image();
	Game.poof5.src = "./player_sprites/_D/win/POOF/5.png"
	Game.poof6 = new Image();
	Game.poof6.src = "./player_sprites/_D/win/POOF/6.png"
	Game.poof7 = new Image();
	Game.poof7.src = "./player_sprites/_D/win/POOF/7.png"
	Game.poof8 = new Image();
	Game.poof8.src = "./player_sprites/_D/win/POOF/8.png"
	Game.poof9 = new Image();
	Game.poof9.src = "./player_sprites/_D/win/POOF/9.png"
	Game.poof10 = new Image();
	Game.poof10.src = "./player_sprites/_D/win/POOF/10.png"
	Game.poof11 = new Image();
	Game.poof11.src = "./player_sprites/_D/win/POOF/11.png"

	Game.pin1 = new Image();
	Game.pin1.src = "./player_sprites/_D/win/PIN/1.png"
	Game.pin2 = new Image();
	Game.pin2.src = "./player_sprites/_D/win/PIN/2.png"
	Game.pin3 = new Image();
	Game.pin3.src = "./player_sprites/_D/win/PIN/3.png"
	Game.pin4 = new Image();
	Game.pin4.src = "./player_sprites/_D/win/PIN/4.png"
	Game.pin5 = new Image();
	Game.pin5.src = "./player_sprites/_D/win/PIN/5.png"
	Game.pin6 = new Image();
	Game.pin6.src = "./player_sprites/_D/win/PIN/6.png"
	Game.pin7 = new Image();
	Game.pin7.src = "./player_sprites/_D/win/PIN/7.png"
	Game.pin8 = new Image();
	Game.pin8.src = "./player_sprites/_D/win/PIN/8.png"
